...
main:   
	...
	addm	$18, $2, $2	# $18 = 0x10bf0000 								`OP0_ADDM    6'h2c 

	lw	$14, 16($2)	# $14 = target = 0x0000005c							`OP_LW       6'h23 // 10 0011
	jr	$14  		#  PC = 0x0000005c	test indirect branches 			`OP0_JR      6'h08

skipped:
	addi	$15, $zero, 1	# skipped so $15 remains 0					`OP_ADDI     6'h08 // 00 1000
	j	skipped	    	# skipped										`OP_J        6'h02 // 00 0010
